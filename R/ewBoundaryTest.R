#' Boundary Test for the Equal Width Method
#' 
#' Tests whether a given point is contained in the bin boundary produced by the Equal Width method
#' 
...
#' 
#' @export
ewBoundaryTest <- function(point, bin, inputs){
